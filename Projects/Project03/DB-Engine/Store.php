...
//        throw new InvalidArgumentException("Documents have to have the primary key \"$primaryKey\". Got data: $documentString");
    ...
    IoHelper::writeContentToFile($storePath, json_encode($data, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE));
...
//        throw new InvalidArgumentException("Documents have to have the primary key \"$primaryKey\". Got data: $documentString");
    ...
    foreach ($data as $document) {
      ...
      IoHelper::writeContentToFile($storePath, json_encode($document, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE));
    }
  ...
  private function writeNewDocumentToStore(array $storeData): array
  {
    ...
    $storableJSON = @json_encode($storeData, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE);
